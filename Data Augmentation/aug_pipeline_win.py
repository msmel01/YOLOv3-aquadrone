...
class PipelineWindow(QDialog):
    ...
    def setupUi(self):
        ...
        self.save_exit_button.clicked.connect(self.saveExit)
    ...
    def setupHorFlipView(self):
        ...
        self.hf_true_box_label = QtWidgets.QLabel(self.hf_param_form)
        self.hf_true_box_label.setText('Always Apply:')
        self.hf_param_form_layout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.hf_true_box_label)
        self.hf_true_box = QtWidgets.QCheckBox(self.hf_param_form)
        self.hf_true_box.setChecked(hf.always_apply)
        self.hf_param_form_layout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.hf_true_box)
        self.hf_true_box.stateChanged.connect(self.setHorFlipApply)
        ...
        self.hf_prob_box.setValue(hf.p)
    ...
    def setHorFlipApply(self): self.aug_param[0].always_apply = self.hf_true_box.isChecked()
